...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    Queue<GuideView> mShowcaseQueue;
    ...
    public MaterialShowcaseSequence addSequenceItem(View targetView, String title, String content, String dismissText) {
        ...
        GuideView sequenceItem = new GuideView.Builder(mActivity)
    ...
    public MaterialShowcaseSequence addSequenceItem(GuideView sequenceItem) {
        mShowcaseQueue.add(sequenceItem);
        return this;
    }
    ...
    private void showNextItem() {
        ...
        if (mShowcaseQueue.size() > 0 && !mActivity.isFinishing()) {
            GuideView sequenceItem = mShowcaseQueue.remove();
    ...
    @Override
    public void onShowcaseDetached(GuideView showcaseView, boolean wasDismissed) {
    ...
    public interface OnSequenceItemShownListener {
        void onShow(GuideView itemView, int position);
    }

    public interface OnSequenceItemDismissedListener {
        void onDismiss(GuideView itemView, int position);
    }
