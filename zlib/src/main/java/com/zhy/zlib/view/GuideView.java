...
import com.zhy.zlib.listener.IDetachedListener;
import com.zhy.zlib.listener.IShowcaseListener;
import com.zhy.zlib.manager.PrefsManager;
import com.zhy.zlib.shape.CircleShape;
import com.zhy.zlib.shape.NoShape;
import com.zhy.zlib.shape.RectangleShape;
import com.zhy.zlib.shape.Shape;
import com.zhy.zlib.target.Target;
import com.zhy.zlib.target.ViewTarget;
 ...
 */
public class GuideView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public ImageView triangleTop, triangleBottom;
    ...
    private void init(Context context) {
        ...
        triangleTop = (ImageView) contentView.findViewById(R.id.triangleTop);
        triangleBottom = (ImageView) contentView.findViewById(R.id.triangleBottom);
    ...
    public static class Builder {
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new GuideView(activity);
        }
...
//                }
    ...
    public void setTriangle(int index) {
        switch (index) {
            case 0:
                triangleTop.setVisibility(GONE);
                break;
            case 1:
                break;
            case 2:
                mContentBox.setGravity(Gravity.RIGHT);
                triangleTop.setImageResource(R.drawable.triangle2);
                break;
            case 3:
                triangleTop.setVisibility(GONE);
                triangleBottom.setVisibility(VISIBLE);
                break;
            case 4:
                triangleTop.setVisibility(GONE);
                triangleBottom.setVisibility(VISIBLE);
                mContentBox.setGravity(Gravity.RIGHT);
                triangleBottom.setImageResource(R.drawable.triangle4);
                break;
        }
