...
import static com.zhy.example.view.MaterialMenuDrawable.*;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, com.zhy.example.R.styleable.MaterialMenuView);
